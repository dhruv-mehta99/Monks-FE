...
final dashboardRepositoryProvider = Provider<DashboardRepository>((ref) => createDashboardRepository());
...
final kpiFiltersProvider = StateNotifierProvider<KpiFiltersController, KpiFilters>((ref) {
...
class KpiFiltersController extends StateNotifier<KpiFilters> {
  ...
  void updateDateRange(DateTimeRange range) => state = state.copyWith(dateRange: range);
